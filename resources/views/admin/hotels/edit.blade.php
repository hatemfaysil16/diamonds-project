        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin/hotels">Hotel</a></li>
          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                ...
                {{ Form::model($row, array('route' => array('hotels.update', $row->id), 'method' => 'PUT', 'files' => true, 'enctype' => 'multipart/form-data')) }}

                <div class="card-body">
                  <div class="form-group col-6 offset-3">
                    <label for="exampleInputEmail1">Image</label>
                    <input type="file" data-default-file="{{ $row->getFirstMediaUrl('hotels') }}" name="image" class="dropify" data-height="300" />
                </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary py-3">
              ...
              {{ Form::open(array('url' => 'admin/hotels/actions/images/' . $row->id , 'files' => true, 'enctype' => 'multipart/form-data')) }}
                  <div class="container-fluid">
                    <div class="row d-flex align-items-center p-3">
                      @if(!$row->getMedia('hotel-gallery')->count())
                      <div class="form-group image col-3">
                        <input type="file" name="images[]" class="dropify" />
                      </div>
                      @endif
                      @foreach ($row->getMedia('hotel-gallery') as $image)
                      <div class="form-group image col-3">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.dropify-clear', function() {
        ...
        jQuery.ajax({
          url: "{{ url('admin/hotels/actions/deleteImage') }}",
          method: 'post',
          data: {
            "_token": "{{ csrf_token() }}",
